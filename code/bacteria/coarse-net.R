...
# pdf("E:/CAF/2022-10-1/Bacteria/fig3/T45R/T45R-a=0.001.pdf",height=2,width=15)
...
# links_gene<-as.data.frame(links_gene)
write.csv(links_gene, file = "E:/CAF/2022-10-20/Bacteria/fig3/T45R/links_gene_May.csv", row.names = F)
...
links_gene$snode <- snode
links_gene$tnode <- tnode
write.csv(links_gene, file = "E:/CAF/2022-10-20/Bacteria/fig3/T45R/links_gene_June.csv", row.names = F)
table(gene_whole_threhold[,1:2])
dim(gene_whole_threhold)
####################################################
...
links_gene$snode <- snode
links_gene$tnode <- tnode
write.csv(links_gene, file = "E:/CAF/2022-10-20/Bacteria/fig3/T45R/links_gene_July.csv", row.names = F)
table(gene_whole_threhold[,1:2])
dim(gene_whole_threhold)
####################################################
...
# colnames(links_gene)<-c("source","tnode")
# links_gene<-as.data.frame(links_gene)
write.csv(links_gene, file = "E:/CAF/2022-10-20/Bacteria/fig3/T45R/links_gene_August.csv", row.names = F)
table(gene_whole_threhold[,1:2])
dim(gene_whole_threhold)
####################################################
...
links_gene$snode <- snode
links_gene$tnode <- tnode
write.csv(links_gene, file = "E:/CAF/2022-10-20/Bacteria/fig3/T45R/links_gene_September.csv", row.names = F)
table(gene_whole_threhold[,1:2])
dim(gene_whole_threhold)
